                ...
                <Table>
                  ...
                  <TableBody>
                    {submissions.map((submission) => {
                      const verdictInfo = VERDICT_LABELS[submission.verdict] || { label: submission.verdict, variant: "outline" as const };
                        ...
                        <TableRow key={submission.id}>
                          ...
                          <TableCell>
                            <Badge
                              ...
                              className={submission.verdict === "accepted" ? "bg-emerald-500 hover:bg-emerald-600" : ""}
                            >
                              {verdictInfo.label}
                            </Badge>
                          </TableCell>
